function [ S3, count, A ] = RecordPoints( P, Sini, xstart, zstart, ysurface,omega, a, b, c, d, e, f )
...
% zARpStart=zARp-eps
% zARpEnd=zARp+eps
% G=table(Point,xARp, zARp, yARp, xARpStart, xARpEnd, zARpStart, zARpEnd, y_up, y_down)


%read table segments
Sini
ID = Sini.('Id');
x1_ARs = Sini.('X1_BoundingBox_Pixel_');
x2_ARs = Sini.('X2_BoundingBox_Pixel_');
z1_ARs = Sini.('Z1_BoundingBox_Pixel_');
z2_ARs = Sini.('Z2_BoundingBox_Pixel_');
y1_ARs = Sini.('Y1_BoundingBox_Pixel_');
y2_ARs = Sini.('Y2_BoundingBox_Pixel_');
x_ARs= Sini.('SizeX_BoundingBox_Pixel_');
z_ARs= Sini.('SizeZ_BoundingBox_Pixel_');
y_ARs= Sini.('SizeY_BoundingBox_Pixel_');
angleXY= Sini.('AngleXY_3DOrientedBounds');
angleXZ= Sini.('AngleXZ_3DOrientedBounds');
angleYZ= Sini.('AngleYZ_3DOrientedBounds');
