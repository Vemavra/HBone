...
% 
% [Sgreen, gcount, Ag]= FindSegments(g_P, g_Sini, g_xstart, g_zstart, g_ysurface, 47.9, -800,1000,-600, 1400, 400, 800)
% filename = '1match_green.xlsx';
% writetable(Ag,filename);

% %function to export qPRS point positions in segmented dataset
% [Ggreen1]= Boxpoints(g_P, g_xstart, g_zstart, g_ysurface)
% filename = 'qPRS_box_green1.xlsx';
